...
Specifically, we'll first make some simplifying assumptions, fitting a modelof continuout trait evolution to the count data, using this model to infer ancestral HLA/FSA gene counts along the phylogeny. 
```{r}
